...
### Created by Peter Forret ( pforret ) on 2023-04-20
...
readonly script_created="2023-04-20"
readonly run_as_root=-1 # run_as_root: 0 = don't check anything / 1 = script MUST run as root / -1 = script MAY NOT run as root
readonly script_description="quick install/preview/deploy for static site generators (Jekyll, Mkdocs)"
## some initialisation
action=""
script_prefix=""
script_basename=""
